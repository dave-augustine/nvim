...
-- general
keyset("n", "<leader>e", vim.cmd.NvimTreeToggle, { silent = true, desc = "NvimTree: Toggle Tree" })
keyset("n", "<leader>t", vim.cmd.NvimTreeFocus, { silent = true, desc = "NvimTree: Focus Tree" })
...
keyset("n", "<space>-", function() vim.cmd.wincmd("_") end, { silent = true, desc = "Maximize Window Vertically" })
keyset("n", "<space>|", function() vim.cmd.wincmd("|") end, { silent = true, desc = "Maximize Window Horizontally" })
...
keyset("n", "<leader>gb", ":Gitsigns blame_line<cr>", { silent = true })
keyset("n", "<leader>gB", ":Gitsigns blame<cr>", { silent = true })
keyset("n", "<leader>gp", ":Octo pr list<cr>", { silent = true, desc = "Octo: PR list" })
